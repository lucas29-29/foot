...
<html>
<head>
    <title>Barre de filtres par championnats</title>
    <style>
...
<body>
    <div class="filter-bar">
        <label for="championnat-select">Sélectionner un championnat :</label>
        <select id="championnat-select">
            <option value="SA">Serie A</option>
            <option value="PPL">Liga NOS</option>
    ...
    <script>
        var selectedChampionnat = "";
        var selectedClub = "";

        // Fonction pour effectuer une requête à l'API avec le filtre du championnat sélectionné
        function effectuerRequete(championnat) {
            // Votre token d'accès
            ...
            // Endpoint pour obtenir les clubs du championnat
            var endpoint = "competitions/" + championnat + "/teams";

            // Construction de l'URL de la requête avec le filtre du championnat
        ...
        // Fonction pour afficher les clubs du championnat sélectionné
        function afficherClubs(reponse) {
            var clubSelect = document.getElementById("club-select");
            clubSelect.innerHTML = ""; // Réinitialisation des clubs

            // Boucle sur les clubs
            for (var i = 0; i < reponse.teams.length; i++) {
                var club = reponse.teams[i];

                // Création d'une option pour afficher le nom du club
                var option = document.createElement("option");
                option.value = club.id;
                option.textContent = club.name;

                // Ajout de l'option aux clubs
        ...
        // Gestionnaire d'événement pour la sélection du championnat
        var selectChampionnat = document.getElementById("championnat-select");
        selectChampionnat.addEventListener("change", function() {
            var championnat = selectChampionnat.value;
            selectedChampionnat = championnat;
            selectedClub = "";
            effectuerRequete(championnat);
        });
